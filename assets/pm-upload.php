...
<html>
	...
	<body>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="right" width="330px"><div  style="font-family: tahoma;font-size:11px;color: #333333;font-weight: bold;">Upload Photo:&nbsp;</div></td>
				<td align="right"><input id="file" type="file" name="image" onChange="window.parent.upload(this);" /></td>
			</tr>
			<tr>
				<td></td>
				<td><span style="font-size:11px; color:#666666;">only gif, png, jpg files.</span></td>
			</tr>		
		</table>
