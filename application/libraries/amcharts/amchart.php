...
abstract class AmChart 
{
	...
	public static $swfObjectPath = "assets/swfobject.js";
	//public static $jQueryPath = "jquery.js";
	public static $jsPath = "assets/AmCharts.js";
	public static $libraryPath = "assets/amcharts";
	...
	public function getCode() 
	{
		...
		$code .= ''
			...
			. 'swfobject.embedSWF("' . $this->getSwfPath() . '", "chart_' . $this->id . '_flash", "' . $width . '", "' . $height . '", "8", "", flashvars, {"wmode":"transparent"}, {}, function(e) {' . "\n"
				. 'if(!e.success) {' . "\n"
					. 'document.getElementById("chart_' . $this->id . '_flash").innerHTML = "Flash player error!";' . "\n"
				. '}' . "\n"
			. '});' . "\n"
			. '// ]]>' . "\n"
			. '</script>' . "\n";
