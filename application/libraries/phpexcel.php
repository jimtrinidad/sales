...
class Phpexcel
{
	 ...
	 */
         ...
         */
        public function __construct($sEncoding = 'UTF-8', $bConvertTypes = true, $sWorksheetTitle = 'Reports')
        {
         ...
         */
        public function generateXML ($filename = 'excel-export',$colwidth="")
        {
                ...
                echo $colwidth;
                $head = $this->lines[0];
                $head = str_replace("<Row>", "<Row ss:StyleID='1'>", $head);
                array_splice($this->lines, 0,1,$head);
